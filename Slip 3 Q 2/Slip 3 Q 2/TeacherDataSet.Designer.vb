...
Partial Public Class TeacherDataSet
    ...
    Partial Public Class TeacherDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddTeacherRow(ByVal Tid As Integer, ByVal Tname As String, ByVal Subject As String) As TeacherRow
            Dim rowTeacherRow As TeacherRow = CType(Me.NewRow,TeacherRow)
            Dim columnValuesArray() As Object = New Object() {Tid, Tname, Subject}
    ...
    Partial Public Class TeacherRow
        ...
        Public Function IsTnameNull() As Boolean
            Return Me.IsNull(Me.tableTeacher.TnameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetTnameNull()
            Me(Me.tableTeacher.TnameColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace TeacherDataSetTableAdapters
    ...
    Partial Public Class TeacherTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Teacher` WHERE ((`Tid` = ?) AND ((? = 1 AND `Tname` IS NULL) OR (`Tn"& _ 
                "ame` = ?)) AND ((? = 1 AND `Subject` IS NULL) OR (`Subject` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Teacher` (`Tid`, `Tname`, `Subject`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Teacher` SET `Tid` = ?, `Tname` = ?, `Subject` = ? WHERE ((`Tid` = ?) AND"& _ 
                " ((? = 1 AND `Tname` IS NULL) OR (`Tname` = ?)) AND ((? = 1 AND `Subject` IS NUL"& _ 
                "L) OR (`Subject` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Slip_3_Q_2.My.MySettings.Default.TeacherConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Tid, Tname, Subject FROM Teacher"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Tid As Global.System.Nullable(Of Integer), ByVal Original_Tname As String, ByVal Original_Subject As String) As Integer
            If (Original_Tid.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_Tid.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Tid As Global.System.Nullable(Of Integer), ByVal Tname As String, ByVal Subject As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Tid As Global.System.Nullable(Of Integer), ByVal Tname As String, ByVal Subject As String, ByVal Original_Tid As Global.System.Nullable(Of Integer), ByVal Original_Tname As String, ByVal Original_Subject As String) As Integer
            If (Tid.HasValue = true) Then
            ...
            End If
            If (Original_Tid.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_Tid.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_Tname,String)
            End If
            If (Original_Subject Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Tname As String, ByVal Subject As String, ByVal Original_Tid As Global.System.Nullable(Of Integer), ByVal Original_Tname As String, ByVal Original_Subject As String) As Integer
            Return Me.Update(Original_Tid, Tname, Subject, Original_Tid, Original_Tname, Original_Subject)
        End Function
    End Class
