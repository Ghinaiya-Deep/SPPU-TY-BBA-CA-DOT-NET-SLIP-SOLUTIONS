...
Partial Public Class EmployeeDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal Eno As Integer, ByVal Ename As String, ByVal Salary As Integer) As EmployeeRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function FindByEno(ByVal Eno As Integer) As EmployeeRow
            Return CType(Me.Rows.Find(New Object() {Eno}),EmployeeRow)
        End Function
    ...
    Partial Public Class EmployeeRow
        ...
        Public Property Eno() As Integer
            Get
                Return CType(Me(Me.tableEmployee.EnoColumn),Integer)
            End Get
            Set
                Me(Me.tableEmployee.EnoColumn) = value
            End Set
        End Property
...
Namespace EmployeeDataSetTableAdapters
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Employee` WHERE ((`Eno` = ?) AND ((? = 1 AND `Ename` IS NULL) OR (`E"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`Eno`, `Ename`, `Salary`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Employee` SET `Eno` = ?, `Ename` = ?, `Salary` = ? WHERE ((`Eno` = ?) AND"& _ 
                " ((? = 1 AND `Ename` IS NULL) OR (`Ename` = ?)) AND ((? = 1 AND `Salary` IS NULL"& _ 
                ") OR (`Salary` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Slip_1_Q_2.My.MySettings.Default.EmployeeConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Eno, Ename, Salary FROM Employee"
