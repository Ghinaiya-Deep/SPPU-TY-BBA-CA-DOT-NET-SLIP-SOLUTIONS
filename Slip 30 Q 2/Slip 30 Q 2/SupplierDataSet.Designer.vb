...
Partial Public Class SupplierDataSet
    ...
    Partial Public Class SupplierDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddSupplierRow(ByVal SupplierID As Integer, ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String) As SupplierRow
            Dim rowSupplierRow As SupplierRow = CType(Me.NewRow,SupplierRow)
            Dim columnValuesArray() As Object = New Object() {SupplierID, SupplierName, PhoneNumber, Address}
    ...
    Partial Public Class SupplierTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Supplier` WHERE ((`SupplierID` = ?) AND ((? = 1 AND `SupplierName` I"& _ 
                "S NULL) OR (`SupplierName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`Pho"& _ 
                "neNumber` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Supplier` (`SupplierID`, `SupplierName`, `PhoneNumber`, `Address`) V"& _ 
                "ALUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Supplier` SET `SupplierID` = ?, `SupplierName` = ?, `PhoneNumber` = ?, `A"& _ 
                "ddress` = ? WHERE ((`SupplierID` = ?) AND ((? = 1 AND `SupplierName` IS NULL) OR"& _ 
                " (`SupplierName` = ?)) AND ((? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Slip_30_Q_2.My.MySettings.Default.SupplierConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SupplierID, SupplierName, PhoneNumber, Address FROM Supplier"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_SupplierName As String, ByVal Original_PhoneNumber As String, ByVal Original_Address As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal SupplierID As Global.System.Nullable(Of Integer), ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal SupplierID As Global.System.Nullable(Of Integer), ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String, ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_SupplierName As String, ByVal Original_PhoneNumber As String, ByVal Original_Address As String) As Integer
            If (SupplierID.HasValue = true) Then
            ...
            End If
            If (Original_SupplierID.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_SupplierID.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal SupplierName As String, ByVal PhoneNumber As String, ByVal Address As String, ByVal Original_SupplierID As Global.System.Nullable(Of Integer), ByVal Original_SupplierName As String, ByVal Original_PhoneNumber As String, ByVal Original_Address As String) As Integer
            Return Me.Update(Original_SupplierID, SupplierName, PhoneNumber, Address, Original_SupplierID, Original_SupplierName, Original_PhoneNumber, Original_Address)
        End Function
    End Class
